      ...
      <main className="flex-1 flex items-center justify-center p-6">
        <Card className="w-full max-w-md p-8 border border-border bg-card shadow-lg rounded-2xl space-y-6">
          <div className="space-y-2 text-center">
            ...
            <p className="text-sm text-muted-foreground">Bắt đầu khám phá không gian học tập Mora</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <Button type="submit" disabled={isRegistering} className="w-full mt-2 cursor-pointer py-5 rounded-xl font-bold">
              {isRegistering ? (
                <>
